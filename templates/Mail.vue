...
<div :id="window.windowId" :style="style" class="window window-style" :class="{
    ...
    <form @submit="sendEmail" action="https://docs.google.com/forms/d/e/1FAIpQLSfPXlw_AtZexaqYQGmZKbzMP6MUffp0DFodh1cS356VaStpvQ/formResponse" class="window-style" id="container" target="hidden_iframe">
        ...
        <div class="content">
            <div class="container-details">
                ...
                <div class="subject-container">
                    ...
                    <div class="receipient">Dany</div>
                </div>
                <hr />
                <div class="subject-container">
                    <p style="margin: 8px">Subject:</p>
                    <input name="entry.1387124472" class="subject" v-model="mailSubject" v-on:input="onChangeMailSubject" type="text" required="true" />
                </div>
                <hr />
                <div class="from-container" style="margin-bottom: 2px">
                    <p style="margin: 8px">From:</p>
                    <input name="entry.1499936129" class="subject" v-model="mailSender" v-on:input="onChangeMailSender" type="email" required="true" />
                </div>
            </div>

            <textarea name="entry.2018345692" v-model="mailContent" v-on:input="onChangeMailContent" required="true"></textarea>
        </div>
    </form>
</div>
</template>
